...
<div class="container" >
  <h2 class="text-center">Form Reset Password</h2>
  <hr>
 ...
 <?php if(null !==$this->session->flashdata('error') ):?>
  ...
  <?php endif;?>
   <form class="form-signin" action="<?php echo site_url('login/reset_action');?>" method="post">
    ...
    <div class="form-group">
      ...
      <div class="input-group">
          <div class="input-group-preprend"> 
              ...
              <input type="password" name="password" class="form-control" placeholder="Masukkan password baru" required="true">
    ...
    <div class="form-group">
      ...
      <div class="input-group">
          <div class="input-group-preprend"> 
              <div class="input-group-text"> <i class="fas fa-unlock"></i></div>  </div>
              <input type="password" name="retype_password" class="form-control" placeholder="ulangi password baru" required="true">
