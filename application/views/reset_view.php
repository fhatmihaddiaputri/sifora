...
<div class="container" >
 ...
 <?php if(null !==$this->session->flashdata('error') ):?>
  ...
  <?php endif;?>
   <form class="form-signin" action="<?php echo site_url('login/reset_validation');?>" method="post">
    ...
    <button class="btn btn-danger mt-2" type="reset" href="<?php echo site_url('login')?>">Batal</button>
